...
import cls from './AccountWishlistProduct.module.scss'
...
import { type ProductProperties } from 'entities/Product'
...
const AccountWishlistProduct = memo(({ id, title, price, preview, properties, className }: WishlistProductProps) => {
...
export default AccountWishlistProduct
