...
export const Light: Story = {
  args: {},
  decorators: [StoreDecorator(primaryState), MemoryRouterDecorator('/article/1', '/article/:id'), BorderedStoryDecorator, ThemeDecorator(Theme.LIGHT)]
}

export const Dark: Story = {
  args: {},
  decorators: [StoreDecorator(primaryState), MemoryRouterDecorator('/article/1', '/article/:id'), BorderedStoryDecorator, ThemeDecorator(Theme.DARK)]
}
